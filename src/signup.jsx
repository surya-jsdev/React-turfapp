            ...
            <div style={style} className='flex justify-center items-center '>
                <form action="" className='rounded-xl w-[400px] bg-[#192436] h-auto p-6 flex flex-col items-center'>
                    ...
                    <div>
                        ...
                        <input type="text" onChange={name} name="name" id="" placeholder='name@example.com' className='border-[#303e51] border-[2px] p-3 w-xs rounded-xl bg-[#0f172a] placeholder: text-white p-2 text-sm' autoComplete='off' />
                    </div>
                    <div>
                        <label htmlFor="email" className='block py-4 text-[#91a0b5] self-start'>Email Address</label>
                        <input type="text" onChange={email} name="email" id="" placeholder='name@example.com' className='border-[#303e51] border-[2px] p-3 w-xs rounded-xl bg-[#0f172a] placeholder: text-white p-2 text-sm' autoComplete='off' />
                    </div>
                    <div>

                        <label htmlFor="password" className='block py-4 text-[#91a0b5] self-start'>Password</label>
                        <input type="password" onChange={password} name="password" id="" placeholder='Create Password' className='border-[#303e51] border-[2px] p-3 w-xs rounded-xl bg-[#0f172a] placeholder: text-white p-2 text-sm' autoComplete='off' />
                    </div>
